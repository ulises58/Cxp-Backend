...
use App\Application\Auth\AuthenticateUserWithPassword;
...
{
    public function __invoke(LoginRequest $request, AuthenticateUserWithPassword $authenticate): JsonResponse
    {
