...
return [
     ...
     */
    'bootstrappers' => [
        // Single-database: sin DatabaseTenancyBootstrapper (docs Stancl).
        // Sin CacheTenancyBootstrapper: driver "database" no soporta tags de Stancl.
        // FilesystemTenancyBootstrapper requiere la ruta `stancl.tenancy.asset` (`routes` => true).
